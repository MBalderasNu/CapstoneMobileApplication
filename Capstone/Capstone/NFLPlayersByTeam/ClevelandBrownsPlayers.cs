...
{
	public class ClevelandBrownsPlayers : ContentPage
	{
        ...
        public ClevelandBrownsPlayers ()
		{
            Cleveland_Browns_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=cleveland-browns&playerstats=Att,Comp,Yds,TD";
