...
{
	public class IndianapolisColtsPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public IndianapolisColtsPlayers ()
		{

            Indianapolis_Colts_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=indianapolis-colts&playerstats=Att,Comp,Yds,TD";
            ...
            using (WebResponse response = await request.GetResponseAsync())
            {
                using (Stream stream = response.GetResponseStream())
                {
                    ...
                    players.Add(new NFLPlayer
                    {
                        Name = k.playerstatsentry[67].player.FirstName + k.playerstatsentry[67].player.LastName,
                        Description = "Position:" + k.playerstatsentry[67].player.Position +
                       "\nJersey Number:" + k.playerstatsentry[67].player.JerseyNumber

                    });

                    players.Add(new NFLPlayer
                    {
                        Name = k.playerstatsentry[68].player.FirstName + k.playerstatsentry[68].player.LastName,
                        Description = "Position:" + k.playerstatsentry[68].player.Position +
                       "\nJersey Number:" + k.playerstatsentry[68].player.JerseyNumber

                    });

                    players.Add(new NFLPlayer
                    {
                        Name = k.playerstatsentry[69].player.FirstName + k.playerstatsentry[69].player.LastName,
                        Description = "Position:" + k.playerstatsentry[69].player.Position +
                       "\nJersey Number:" + k.playerstatsentry[69].player.JerseyNumber
                    ...
                    players.Add(new NFLPlayer
                    {
                        Name = k.playerstatsentry[70].player.FirstName + k.playerstatsentry[70].player.LastName,
                        Description = "Position:" + k.playerstatsentry[70].player.Position +
                      "\nJersey Number:" + k.playerstatsentry[70].player.JerseyNumber
