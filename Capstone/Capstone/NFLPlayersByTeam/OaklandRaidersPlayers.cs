...
{
	public class OaklandRaidersPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public OaklandRaidersPlayers ()
		{

            Oakland_Raiders_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=oakland-raiders&playerstats=Att,Comp,Yds,TD";
