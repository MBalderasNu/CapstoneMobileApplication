...
{
	public class NewYorkJetsPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public NewYorkJetsPlayers ()
		{
            New_York_Jets_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=newyork-jets&playerstats=Att,Comp,Yds,TD";
