...
{
	public class BuffaloBillsPlayers : ContentPage
	{
        ...
        public BuffaloBillsPlayers ()
		{
            Buffalo_Bills_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=buffalo-bills&playerstats=Att,Comp,Yds,TD";
