...
{
	public class PittsburghSteelersPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public PittsburghSteelersPlayers ()
		{
            Pittsburgh_Steelers_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=pittsburgh-steelers&playerstats=Att,Comp,Yds,TD";
