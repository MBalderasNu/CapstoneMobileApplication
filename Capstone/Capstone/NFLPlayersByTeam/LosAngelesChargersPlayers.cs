...
{
	public class LosAngelesChargersPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public LosAngelesChargersPlayers ()
		{
            Los_Angeles_Chargers_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=losangeles-chargers&playerstats=Att,Comp,Yds,TD";
