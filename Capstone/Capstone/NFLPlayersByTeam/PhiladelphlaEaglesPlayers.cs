...
{
	public class PhiladelphlaEaglesPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public PhiladelphlaEaglesPlayers ()
		{
            Philadelphia_Eagles_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=philadelphia-eagles&playerstats=Att,Comp,Yds,TD";
