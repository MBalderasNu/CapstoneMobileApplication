...
{
	public class BaltimoreRavensPlayers : ContentPage
	{
        ...
        public BaltimoreRavensPlayers ()
		{
            Baltimore_Ravens_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=baltimore-ravens&playerstats=Att,Comp,Yds,TD";
