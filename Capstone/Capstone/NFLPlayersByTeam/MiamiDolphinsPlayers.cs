...
{
	public class MiamiDolphinsPlayers : ContentPage
	{
        ...
        public MiamiDolphinsPlayers ()
		{
            Miami_Dolphins_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=miami-dolphins&playerstats=Att,Comp,Yds,TD";
