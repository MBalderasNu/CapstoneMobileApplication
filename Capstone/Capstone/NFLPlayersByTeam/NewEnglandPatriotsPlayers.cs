...
{
	public class NewEnglandPatriotsPlayers : ContentPage
	{
        ...
        public NewEnglandPatriotsPlayers ()
		{

            New_England_Patriots_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=newengland-patriots&playerstats=Att,Comp,Yds,TD";
