...
{
	public class SeattleSeahawksPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public SeattleSeahawksPlayers ()
		{
            Seattle_Seahawks_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=seattle-seahawks&playerstats=Att,Comp,Yds,TD";
