...
{
	public class WashingtonRedskinsPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public WashingtonRedskinsPlayers ()
		{
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=washington-redskins&playerstats=Att,Comp,Yds,TD";
