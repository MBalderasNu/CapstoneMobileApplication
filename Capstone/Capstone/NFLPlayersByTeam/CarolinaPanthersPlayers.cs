...
{
	public class CarolinaPanthersPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public CarolinaPanthersPlayers ()
		{
            Carolina_Panthers_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=carolina-panthers&playerstats=Att,Comp,Yds,TD";
