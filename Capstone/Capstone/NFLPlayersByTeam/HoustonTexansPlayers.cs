...
{
	public class HoustonTexansPlayers : ContentPage
	{
        ...
        public HoustonTexansPlayers ()
		{
            Houston_Texans_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=houston-texans&playerstats=Att,Comp,Yds,TD";
