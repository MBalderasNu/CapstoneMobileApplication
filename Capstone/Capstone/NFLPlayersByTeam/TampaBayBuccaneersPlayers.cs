...
{
	public class TampaBayBuccaneersPlayers : ContentPage
	{
        ...
        public TampaBayBuccaneersPlayers ()
		{

            Tampa_Bay_Buccaneers_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=tampabay-buccaneers&playerstats=Att,Comp,Yds,TD";
