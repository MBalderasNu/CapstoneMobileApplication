...
{
	public class NewYorkGiantsPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public NewYorkGiantsPlayers ()
		{

            New_York_Giants_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=newyork-giants&playerstats=Att,Comp,Yds,TD";
