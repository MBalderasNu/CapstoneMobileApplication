...
{
	public class DenverBroncosPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public DenverBroncosPlayers ()
		{

            Denver_Broncos_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=denver-broncos&playerstats=Att,Comp,Yds,TD";
