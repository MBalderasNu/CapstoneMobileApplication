...
{
	public class JacksonvilleJaguarsPlayers : ContentPage
	{
        ...
        public JacksonvilleJaguarsPlayers ()
		{
            Jacksonville_Jaguars_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=jacksonville-jaguars&playerstats=Att,Comp,Yds,TD";
