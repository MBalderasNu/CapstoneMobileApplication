...
{
	public class DetroitLionsPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public DetroitLionsPlayers ()
		{

            Detroit_Lions_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=detroit-lions&playerstats=Att,Comp,Yds,TD";
