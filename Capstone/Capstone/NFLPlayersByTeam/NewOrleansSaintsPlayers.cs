...
{
	public class NewOrleansSaintsPlayers : ContentPage
	{
        ...
        public NewOrleansSaintsPlayers ()
		{

            New_Orleans_Saints_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=neworleans-saints&playerstats=Att,Comp,Yds,TD";
