...
{
	public class LosAngelesRamsPlayers : ContentPage
	{
        ...
        public LosAngelesRamsPlayers ()
		{

            Los_Angeles_Rams_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=losangeles-rams&playerstats=Att,Comp,Yds,TD";
