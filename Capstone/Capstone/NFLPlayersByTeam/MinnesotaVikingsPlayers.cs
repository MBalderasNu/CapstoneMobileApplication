...
{
	public class MinnesotaVikingsPlayers : ContentPage
	{
        ...
        public MinnesotaVikingsPlayers ()
		{
            Minnesota_Vikings_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=minnesota-vikings&playerstats=Att,Comp,Yds,TD";
