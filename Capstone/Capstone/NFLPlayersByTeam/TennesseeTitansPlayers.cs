...
{
	public class TennesseeTitansPlayers : ContentPage
	{
        ...
        public TennesseeTitansPlayers ()
		{

            Tennessee_Titans_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=tennessee-titans&playerstats=Att,Comp,Yds,TD";
