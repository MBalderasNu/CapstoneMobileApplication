...
{
	public class CincinnatiBengalsPlayers : ContentPage
	{
        string username = "";
        string password = "";
        ...
        public CincinnatiBengalsPlayers ()
		{

            Cincinnati_Bengals_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=cincinnati-bengals&playerstats=Att,Comp,Yds,TD";
