...
{
	public class SanFrancisco49ersPlayers : ContentPage
	{
        ...
        public SanFrancisco49ersPlayers ()
		{
            SanFrancisco_49ers_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=sanfrancisco-49ers&playerstats=Att,Comp,Yds,TD";
