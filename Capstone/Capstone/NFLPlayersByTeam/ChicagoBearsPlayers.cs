...
{
    public class ChicagoBearsPlayers : ContentPage
    {
        string username = "";
        string password = "";
        ...
        public ChicagoBearsPlayers()
        {

            Chicago_Bears_Offense();
        ...
        {
            string url = "https://api.mysportsfeeds.com/v1.2/pull/nfl/2017-regular/cumulative_player_stats.json?team=chicago-bears&playerstats=Att,Comp,Yds,TD";
